                      ...
                      struct curltime timestamp)
{
  ...
  case TIMER_STARTSINGLE:
    ...
    infof(data, "%s,timestamp:%d,%d\n", __func__, timestamp.tv_sec, timestamp.tv_usec);
    data->progress.t_startsingle.tv_sec = timestamp.tv_sec;
    data->progress.t_startsingle.tv_usec = timestamp.tv_usec;
