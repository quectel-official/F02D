...
/**
 ****************************************************************************************
 * @defgroup COMMON_TIME Utilities
 * @ingroup COMMON
 ...
 ****************************************************************************************
 */
typedef void (*common_time_timer_cb)(void* p_env);

/// Timer structure
typedef struct common_time_timer
{
    /// Pointer to next timer in timer list
    struct common_time_timer * p_next;
    ...
    common_time_timer_cb       cb;
    /// Expiration time [0-31] part (in milliseconds)
    uint32_t               exp_time_ms_lsb;
    /// Timer bit field (@see enum common_time_timer_bf)
    uint32_t               timer_bf;
} common_time_timer_t;


/// Time Structure
typedef struct common_time
{
 ...
 ****************************************************************************************
 */
void common_time_init(uint8_t init_type);
 ...
 ****************************************************************************************
 */
common_time_t common_time_get(void);
 ...
 ****************************************************************************************
 */
void common_time_compensate(uint32_t delta_time_ms_lsb, uint8_t delta_time_ms_msb);
 ...
 ****************************************************************************************
 */
void common_time_timer_init(common_time_timer_t* p_timer, common_time_timer_cb cb, void* p_env);
 ...
 ****************************************************************************************
 */
void common_time_timer_set(common_time_timer_t* p_timer, uint32_t delay_ms);
 ...
 ****************************************************************************************
 */
void common_time_timer_long_set(common_time_timer_t* p_timer, uint32_t delay_ms_lsb, uint8_t delay_ms_msb);
 ...
 ****************************************************************************************
 */
void common_time_timer_periodic_set(common_time_timer_t* p_timer, uint32_t period_ms);
 ...
 ****************************************************************************************
 */
void common_time_timer_stop(common_time_timer_t* p_timer);
