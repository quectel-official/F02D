...
enum dbg_swdiag
{
    ...
    */
    ...
    DBG_SWDIAG_KERNEL_TIMER_OFFSET                  = 0,
    DBG_SWDIAG_KERNEL_TIMER_MASK                    = 0x01,

    DBG_SWDIAG_KERNEL_MESSAGE_OFFSET                = 1,
    DBG_SWDIAG_KERNEL_MESSAGE_MASK                  = 0x02,

    DBG_SWDIAG_KERNEL_MALLOC_OFFSET                 = 2,
    DBG_SWDIAG_KERNEL_MALLOC_MASK                   = 0x04,

    DBG_SWDIAG_KERNEL_FREE_OFFSET                   = 3,
    DBG_SWDIAG_KERNEL_FREE_MASK                     = 0x08,
    ...
    */
    ...
    DBG_SWDIAG_IP_ISR_COMMON_TIMER_OFFSET          = 1,
    DBG_SWDIAG_IP_ISR_COMMON_TIMER_MASK            = 0x02,
    ...
    */
    ...
    DBG_SWDIAG_TST_RX_TRIGGER_OFFSET                 = 2,
    DBG_SWDIAG_TST_RX_TRIGGER_MASK                   = 0x04,
