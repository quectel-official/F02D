 ...
 ****************************************************************************************
 */
void ble_aes_h6(const uint8_t* w, const uint8_t* key_id, ble_aes_func_result_cb res_cb, uint32_t src_info);
 ...
 ****************************************************************************************
 */
void ble_aes_h7(const uint8_t* salt, const uint8_t* w, ble_aes_func_result_cb res_cb, uint32_t src_info);
