 ...
 ****************************************************************************************
 */
uint8_t ecc_generate_key256(uint8_t key_type, const uint8_t* secret_key, const uint8_t* public_key_x, const uint8_t* public_key_y, kernel_msg_id_t msg_id, kernel_task_id_t task_id, bool public_key_valid);
