...
#define ISOOHCI_IN_BUF_POOL_SIZE   ((COMMON_ALIGN4_HI(BLE_HCI_ISO_IN_BUF_NB * (sizeof(isoohci_buffer_t) + BLE_HCI_ISO_IN_BUF_SIZE))))
...
struct isoohci_env_tag
{
    ...
    struct common_list           hci_wait_tx_queue;
    /// list of TX buffer in HCI transmission queue
    struct common_list           hci_in_tx_queue;
