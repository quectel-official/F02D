...
#define EM_BLE_LLCPTXBUF_SIZE      COMMON_ALIGN4_HI(LL_PDU_LENGTH_MAX) // ensure that LLCP buffer is 32bits aligned
...
#define EM_BLE_ISO_HOP_SEQ_OFFSET               COMMON_ALIGN4_HI(EM_BLE_ACLTXBUF_END)
#define EM_BLE_ISO_HOP_SEQ_NB                   (BLE_ISO_HOP_SEQ_NB)
#define EM_BLE_ISO_HOP_SEQ_SIZE                 COMMON_ALIGN4_HI(BLE_ISO_HOP_SEQ_SIZE)
 ...
 */
#define EM_BLE_ISO_DESC_OFFSET                COMMON_ALIGN4_HI(EM_BLE_ISO_HOP_SEQ_END)
...
#define EM_BLE_RX_CTE_DESC_OFFSET      COMMON_ALIGN4_HI(EM_BLE_ISO_BUF_END)
